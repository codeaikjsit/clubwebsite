...
const rawCodeaiImages = {
  ...
  community: "/events/level-up-2.jpg",
...
export type TenureYear = "2026-27" | "2025-26";

export type TeamMember = {
  name: string;
  role: string;
  domain?: "marketing" | "organising" | "pr" | "creative" | "technical";
  initials: string;
  tone: "lime" | "coral" | "blue" | "cream";
  linkedin?: string;
  instagram?: string;
};
...
export const siteContent = {
  ...
  hackathon: {
    ...
    timeline: [
      ...
      { time: "08:30", label: "Build Phase I — 4 hours" },
      { time: "12:30", label: "Mentorship Round" },
      { time: "13:30", label: "Build Phase II — 4 hours" },
      { time: "17:30", label: "Submission, Evaluation & Closing" },
    ],
  ...
  people: {
    ...
    defaultTenure: "2026-27" as TenureYear,
    tenures: [
      { id: "2026-27" as TenureYear, label: "2026-27 (Current)", badge: "CURRENT TENURE", isCurrent: true },
      { id: "2025-26" as TenureYear, label: "2025-26", badge: "PAST TENURE", isCurrent: false },
    ] as TenureOption[],
    byTenure: {
      "2026-27": {
        core: [
    ...
    get core() {
      return this.byTenure["2026-27"].core;
    },
    get subcore() {
      return this.byTenure["2026-27"].subcore;
    },
    get members() {
      return this.byTenure["2026-27"].members;
    },
  },
  faculty: {
